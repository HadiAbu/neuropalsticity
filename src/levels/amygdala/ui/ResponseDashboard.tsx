...
export function ResponseDashboard() {
  ...
  return (
    <section className="rounded-lg bg-slate-800/95 p-5 text-slate-100 shadow-lg">
      <p className="text-sm uppercase tracking-wide text-amber-300">{result.stimulus.label}</p>
      ...
      <p className="mt-4 text-base leading-relaxed text-slate-300">{result.stimulus.explanation}</p>
