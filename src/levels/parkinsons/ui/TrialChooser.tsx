...
export function TrialChooser() {
  ...
  return (
    <nav aria-label="Choose a motor test" className="rounded-lg bg-slate-800/95 p-5 text-slate-100 shadow-lg">
      <h2 className="mb-1 text-xl font-semibold">Run a bedside test</h2>
      <p className="mb-4 text-base text-slate-300">Dopamine to the basal ganglia is depleted. What happens when…</p>
