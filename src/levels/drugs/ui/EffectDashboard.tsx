...
export function EffectDashboard() {
  ...
  return (
    <section className="rounded-lg bg-slate-800/95 p-5 text-slate-100 shadow-lg">
      <p className="text-xs uppercase tracking-wide text-amber-300">{substance.label} · {substance.drugClass}</p>
      ...
      <p className="mt-4 text-sm leading-relaxed text-slate-300">{substance.explanation}</p>
      <p className="mt-3 rounded-md border-l-2 border-amber-400 bg-slate-900/60 p-3 text-sm text-slate-300">{substance.dayToDay}</p>
