...
export function PredictionPrompt() {
  ...
  return (
    <section className="rounded-lg bg-slate-800/95 p-5 text-slate-100 shadow-lg">
      <p className="text-sm uppercase tracking-wide text-amber-300">{substance.label}</p>
      <h2 className="mb-1 mt-1 text-xl font-semibold">Before you look — what do they feel?</h2>
      <p className="mb-4 text-base text-slate-300">{substance.scenario}</p>
