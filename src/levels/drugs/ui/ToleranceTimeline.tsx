...
export function ToleranceTimeline() {
  ...
  return (
    <section className="rounded-lg bg-slate-800/95 p-5 text-slate-100 shadow-lg">
      <h2 className="mb-2 text-lg font-semibold">The brain adapts — and that is the problem</h2>
      <p className="mb-3 text-sm leading-relaxed text-slate-300">{mechanism}</p>
      <p className="mb-4 rounded-md border-l-2 border-amber-400 bg-slate-900/60 p-3 text-sm text-slate-300">
        <span className="font-semibold text-slate-100">{substance.label}: </span>
        {substance.adaptation}
      </p>

      <label htmlFor="tolerance-week" className="mb-1 block text-sm font-medium">
